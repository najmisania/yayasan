...
<div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form class="form-horizontal" method="POST" action="<?php echo base_url('/index.php/infaq/update_infaq') ?>">
                    <div class="form-group row">
                      <label class="col-sm-2">Bulan</label>
                      <div class="col-sm-4">
                        <input id="inputHorizontalSuccess" type="text" name="bulan" placeholder="" value="<?php echo $biodata_guru[0]->nuptk ?>" class="form-control form-control-success"><small class="form-text"></small>
                      </div>
                    </div>
                    <div class="form-group row">
